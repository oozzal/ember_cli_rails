...
define('frontend/adapters/application', ['exports', 'ember-data', 'jquery'], function (exports, DS, $) {

  'use strict';

  exports['default'] = DS['default'].RESTAdapter.extend({
    headers: {
      'X-CSRF-Token': $['default']('meta[name="csrf-token"]').attr('content')
    }
  });
...
define('frontend/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"frontend","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"frontend","version":"0.0.0.6e84db49"},"contentSecurityPolicyHeader":"Content-Security-Policy-Report-Only","contentSecurityPolicy":{"default-src":"'none'","script-src":"'self' 'unsafe-eval'","font-src":"'self'","connect-src":"'self'","img-src":"'self'","style-src":"'self'","media-src":"'self'"},"exportApplicationGlobal":true}};
});

if (runningTests) {
  require("frontend/tests/test-helper");
} else {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0.6e84db49"});
}
